    ...
    <div>
      <div className="">
        ...
        >
          ...
          >
            <div className="space-y-2 absolute top-5 right-3">
              <div>
            ...
            <div className="font-medium w-full bg-white hover:bg-black hover:text-white transition-colors duration-300 rounded-lg text-center py-2.5 cursor-pointer">
              Add to Cart
            </div>
          </div>
        </div>
